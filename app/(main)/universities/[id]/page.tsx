...
export default async function UniversityDetailsPage({ params }: PageProps) {
  ...
  const firstPart = aboutWords.slice(0, 120).join(" ");
  const secondPart = aboutWords.slice(50).join(" ");
    ...
    <main className="min-h-screen bg-[#F8FAFC] pb-20">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="bg-linear-to-r from-[#F0F2FD] via-[#FFFFFF] to-[#FDFBF2] rounded-[32px] md:rounded-[50px] p-6 md:p-10 shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-white flex flex-col md:flex-row items-center gap-8">
            <div className="bg-white p-5 rounded-3xl shadow-sm border border-gray-50 shrink-0 w-32 h-32 md:w-40 md:h-40 flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 mt-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <section className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
              ...
              <div className="text-[#475569] text-lg leading-relaxed text-justify space-y-6">
                ...
                {university.aboutImage && (
                  <div className="relative w-full h-75 md:h-112.5 rounded-3xl overflow-hidden my-8 shadow-md bg-gray-100">
                    <Image
            ...
            <section>
              ...
              <div className="space-y-4">
                {university.departments?.map((dept: any) => (
                  /* Main Container */
                  <div
                    key={dept._id}
                  ...
                  >
                    ...
                    <label className="cursor-pointer select-none">
                      ...
                      <div className="grid grid-rows-[0fr] transition-all duration-500 ease-in-out peer-checked:grid-rows-[1fr]">
          ...
          <aside className="lg:col-span-4 space-y-8">
            <div className="bg-[#0891B2] text-white p-8 rounded-sm shadow-xl sticky top-24">
                ...
                <div className="pt-4">
                  <div className="bg-white/20 backdrop-blur-sm text-white p-5 rounded-2xl border border-white/30">
                    ...
                    <p className="text-[11px] font-medium leading-relaxed text-cyan-50">
                      Typically issued within 7-14 working days after successful
